...
```
```{r}
sw <- s$weight #does not want to knit past this point, could not find reason why, did not understande error message
m1 <- mean(sw)
m1
n1 <- length(sw)
n1
...
#error is given saying undefined columns selected, not sure why, could not find answer
```
